...
-- As described in wind_turbine.ads, there are certain wind speeds that set the conditions of the brake systems. If the wind speed is too low to induce inertia in the turbine, then both brake systems are applied.
